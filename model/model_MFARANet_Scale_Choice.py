...
class MFARANet_Scale_Choice(nn.Module):
    def __init__(self, backbone_name='resnet18_deep_stem', use_aux_loss=True, 
        ...
        super(MFARANet_Scale_Choice, self).__init__()
        ...
        self.layer0 = nn.Sequential(resnet.conv1, resnet.bn1, resnet.relu, nn.Dropout2d(self.Dropout_Rate_CNN[0]) if self.Dropout_Rate_CNN[0] > 0. else nn.Identity(), resnet.maxpool)
